...
check the /scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals folder
...
useage:
  ...
  3. cd to the ldsc directory
  4. open the WrapperScript.sh file and edit the working directories and folder names 
  5. submit the sh file using: sh WrapperScript.sh
  6. individual outputs will be saved in to the jf_results folder and LDSC log files will be saved into Logs folder

2. Figure 3-4 - genetic correlation with external trait
...
setwd('/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals/ldsc/')
...
ggsave(rghealth1, file="/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals/figures_ldsc/p_nonp_rgs_health.tiff", width=13, height=11)
...
ggsave(rgpsych1, file="/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals/figures_ldsc/p_nonp_rgs_psychological.tiff", width=13, height=11)
...
ggsave(fig_demographic1, file="/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals/figures_ldsc/p_nonp_rgs_demographic.tiff", width=13, height=9)
...
ggsave(rganthro1, file="/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/robustness_check/ldsc_nonp_externaltrait_residuals/figures_ldsc/p_nonp_rgs_anthropometric.tiff", width=11, height=7)
