#!/bin/bash -l
#SBATCH --output=/scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/ALCH_genomicSEM1_%A_%a.out
#SBATCH --error=/scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/ALCH_genomicSEM1_%A_%a.err
...
#SBATCH --job-name=ALCH
#SBATCH --mail-type=END
#SBATCH --mail-user=engin.keser@kcl.ac.uk
...
Rscript --vanilla /scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/ALCH_genomicSEM.R -s $start_row -e $end_row
