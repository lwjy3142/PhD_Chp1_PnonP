...
```{r, file='/scratch/prj/teds/Sumstate_PRS_Codelab/disease_specificity/script/create_chunk_universal.R'}
```
...
```{bash, file = './array_genomicSEM_P.sh'}
```

```{r, file='./P_genomicSEM_meta.R'}
```
