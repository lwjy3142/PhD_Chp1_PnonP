#!/bin/bash -l
#SBATCH --output=/scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/AN_genomicSEM1_%A_%a.out
#SBATCH --error=/scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/AN_genomicSEM1_%A_%a.err
...
Rscript --vanilla /scratch/prj/teds/Sumstate_PRS_Codelab/robustness_check/AN_genomicSEM.R -s $start_row -e $end_row
